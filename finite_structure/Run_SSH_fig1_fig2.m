% This code is used to plot the figure 1 and 2
% Initializing the size of the resonator chain
k=10;
N = 4*k+1;
...
function [f_exp,V] = produce_fexp_edge(N,eps_modulation)
    ...
    daspect([1 1 1])
    hold off
    % comment out the next line or put a break point here to show the structure plot 
    close
    ...
    %% Solve Floquet exponents and sort the modes according to them
