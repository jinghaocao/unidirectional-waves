% Supercell edge modes, used to produce Figure 5,9, 10 and 11

% Number of Resonators, change the number k to very large, for example such
% that N = 120 to obatin figure 11
k = 4;
ll = 1;
N = 6*k*ll;

% define the phase shift of the time modulation
...
% define the index for the edge modes
edge_ind = [k*2 k*2+1];

% plot the edge modes: Figure 5
figure
...
% compute analytically the eigenvector perturbation
...
% Perturbed case; Figure 11. Change mu = 0, kk = 1 and the corresponding
% legends to obtain figure 9
eps = 0.2;
V_mode_mu_1 =[];
V_mode_mu_2 =[];
kk = 1000;
